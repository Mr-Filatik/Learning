...
namespace BlazorAppWASM.Server.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        private static List<Product> products = new List<Product>()
        {
            ...
            new Product { Id = 4, Name = "Product 4", Description = "...", Price = 40M },
            new Product { Id = 5, Name = "Product 5", Description = "...", Price = 50M },
            new Product { Id = 6, Name = "Product 6", Description = "...", Price = 60M },
            new Product { Id = 7, Name = "Product 7", Description = "...", Price = 70M },
            new Product { Id = 8, Name = "Product 8", Description = "...", Price = 80M },
        };
